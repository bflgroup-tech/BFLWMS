...
public static class MenuKeys
{
    ...
    public static readonly IReadOnlyList<MenuEntry> All = new[]
    {
        ...
        new MenuEntry(TCM_LABORATORY,         "TCM Lab",             "Upload TCM File",            "tcm-laboratory",            new[] { Roles.Admin, Roles.WHManager, Roles.WHSupervisor }),
        ...
        new MenuEntry(RPT_WAREHOUSE_INCENTIVES, "Incentives",       "Warehouse Incentives",    "reports/warehouse-incentives", new[] { Roles.Admin, Roles.Reports }),
