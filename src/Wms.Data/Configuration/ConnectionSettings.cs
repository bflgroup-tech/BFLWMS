...
namespace Wms.Data.Configuration;

/// <summary>
/// Resolves connection strings the WMS app uses at runtime. Three kinds:
///
///   1. Azure SQL WMS — the app's own DB on bfl-wms-sql. Connected via
